...
public class Usuario {
    ...
    public Usuario(com.digis01.MsanchezProgramacionNCapas.JPA.Usuario usuarioML) {
        ...
        if (usuarioML.Direcciones.get(0).getIdDireccion() == -1) {
            ...
            for (com.digis01.MsanchezProgramacionNCapas.JPA.Direccion Direccione : usuarioML.Direcciones) {
